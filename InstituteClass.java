...
class Institute {
	...
	public String toString() {
		...
		// Instruction:
		// 1. Loop through all the students stored in the instance variable:
		// ArrayList<Student> students and return a String that contains the each name
		// and roll number of each student
		// 2. An example String to be returned should look like:
		// "Christ Academy: Vigyan 1, Vedanshi 2, Jahnvi 3, Abhiraj 4, "// notice the
		// extra comma and space at the end
